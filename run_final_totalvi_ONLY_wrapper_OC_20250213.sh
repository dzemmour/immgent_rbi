...
working_dir=/n/groups/cbdm_lab/odc180/ImmgenT_workshop/Integration_Webpage/Trial_WPRE/
path_to_matrix=/n/groups/cbdm_lab/odc180/ImmgenT_workshop/Integration_Webpage/Trial_WPRE/matrix/
sample_sheet=/n/groups/cbdm_lab/odc180/ImmgenT_workshop/Integration_Webpage/Trial_WPRE/cell_level_samples.csv
## Stays constant
